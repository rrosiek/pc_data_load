...
class GrantsDataMapper(DataMapper):
    @staticmethod
    ...
    def clean_date(date_str):
        ...
        if len(comps) == 3:
            month = GrantsDataMapper.pad_zeros(comps[0], 2)
            day = GrantsDataMapper.pad_zeros(comps[1], 2)
            year = comps[2]
    ...
    def update_doc(existing_doc, _id, data_source_name, data):
        new_doc = GrantsDataMapper.create_doc(_id, data_source_name, data)
        update_doc = new_doc
