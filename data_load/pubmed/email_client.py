...
class EmailClient(object):
    ...
    def get_title(self, pmid):
        ...
        data_loader_utils = DataLoaderUtils(self.load_config.server, self.load_config.index, self.load_config.type)
    ...
    def send_notification_for_prospect(self, prospect, local_date=None):
        ...
        for doc in docs_with_matching_citations:
            ...
            for prospective_cite in prospective_cites:
                prospective_cite_title = self.get_title(prospective_cite)
